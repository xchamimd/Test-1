...
cmd({
  ...
  category: "download",
  filename: __filename
}, async (xCHAMi, mek, m, { from, q, sender, reply }) => {
...
cmd({
...
}, async (xCHAMi, mek, m, { body, sender, reply, from }) => {
  // Updated xCHAMi usage
  await xCHAMi.sendMessage(from, { react: { text: "✅", key: m.key } });
  ...
  if (metadata.thumbnail) {
    // Updated xCHAMi usage
    await xCHAMi.sendMessage(from, { image: { url: metadata.thumbnail }, caption: msg }, { quoted: mek });
  } else {
    // Updated xCHAMi usage
    await xCHAMi.sendMessage(from, { text: msg }, { quoted: mek });
  }
  ...
  // Updated xCHAMi usage
  await xCHAMi.sendMessage(from, { text: qualityMsg }, { quoted: mek });
});
