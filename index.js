...
const prefix = '.';
const ownerNumber = ['94701171975']; // අවශ්‍ය නම් මෙය වෙනස් කරන්න
...
async function connectToWA() {
  console.log("Connecting xCHAMi-MD 🧬..."); // නම වෙනස් කරන ලදී
  ...
  danuwa.ev.on('connection.update', async (update) => {
    ...
    if (connection === 'close') {
      ...
      console.log('✅ xCHAMi-MD connected to WhatsApp'); // නම වෙනස් කරන ලදී
...
app.get("/", (req, res) => {
  res.send("Hey, xCHAMi-MD started✅"); // මෙතනත් නම වෙනස් කළා
});
